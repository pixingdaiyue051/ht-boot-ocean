...
import com.tequeno.iou.enums.HtSeqPrefixEnum;
import com.tequeno.iou.enums.JedisKeyPrefixEnum;
import com.tequeno.iou.enums.JedisLockTimeEnum;
import com.tequeno.iou.utils.HtDateUtil;
...
//    }
    ...
    public boolean keysDel(String pattern) {
        try {
            String script = "local scanResultIndex = 0\n" +
